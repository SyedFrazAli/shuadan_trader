...
const List<String> list = <String>['Wholesaler/Trader', 'Distributor', 'Importer', 'Manufacturer'];
...
class _wSignupState extends State<wSignup> {
  ...
  value: dropdownValue,
  icon: const Icon(Icons.arrow_drop_down_circle_outlined, color: Color(0xFF8be28e),),
  elevation: 16,
